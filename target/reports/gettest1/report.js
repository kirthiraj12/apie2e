$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("src/test/resources/features/gettestcase1.feature");
formatter.feature({
  "name": "get request cucumber test acceptest2",
  "description": "",
  "keyword": "Feature",
  "tags": [
    {
